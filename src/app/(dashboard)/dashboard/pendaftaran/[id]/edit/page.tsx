...
export default async function EditPendaftaranPage({
  ...
  const { data: pendaftaran, error } = await getRegistrationById(params.id);
    ...
    return (
        <div className="container mx-auto max-w-2xl py-10">
            <Alert variant="destructive">
                ...
                <AlertDescription>
                    Pendaftaran ini sudah tidak bisa diubah karena telah difinalisasi atau sedang dalam proses review.
                </AlertDescription>
            </Alert>
        </div>
    )
